...
def add_recipe():
    if request.method == "POST":
        recipe = {
            ...
            "recipe_meal_type": request.form.getlist("recipe_meal_type"),
            "recipe_cuisine_type": request.form.getlist("recipe_cuisine_type"),
            "recipe_diet_type": request.form.getlist("recipe_diet_type"),
